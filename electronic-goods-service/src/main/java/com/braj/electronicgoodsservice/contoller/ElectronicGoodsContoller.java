...
public class ElectronicGoodsContoller {
	...
	public EProduct getDiscountRateByItemId(@PathVariable Integer itemId) {
		...
		return new EProduct(2, "Mobile", discountedAmount.getItemPrice());
	...
	public EProduct getDiscountedRateByItemId(@PathVariable Integer itemId) {
		...
		return new EProduct(2, "Mobile"+discountPrice.get().getItemName(), discouPrice);
